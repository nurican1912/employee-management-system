...
namespace EmployeeManagementSystem.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentId,Name")] Department department)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException)
                {
                    ...
                    ModelState.AddModelError("", "Departman güncellenirken bir hata oluştu. Lütfen tekrar deneyin.");
                }
            }
            return View(department);
        }
        ...
        public async Task<IActionResult> EmployeeCount(int id)
        {
            ...
            var count = await _departmentService.GetEmployeeCountAsync(id);
            ViewBag.Count = count;
            ViewBag.Department = department;
            ViewData["Title"] = $"{department.Name} - Çalışan Sayısı";
            return View();
        }
    }
}
